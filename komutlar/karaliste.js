...
exports.run = async (client, message, args) => {
 if(message.author.id !== "519126074148519939") if(message.author.id !== "535153673076998155") return message.channel.send("Bu komudu kullanabilmek için sahibim olmalısın.");
  let user = args[0]
  ...
  .setFooter("Santos")
  .setTimestamp()
  .setDescription(` <@${message.author.id}> adlı yetkilimiz tarafından karalisteye alındın! Artık Santos'u kullanamazsın. Karalisteye alınma sebebin: **${sebep}**`)
